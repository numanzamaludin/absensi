...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2025 at 06:51 PM
...
VIEW `absensi_tidak_sesuai_jadwal` AS 
SELECT 
  a.id_absensi, 
  a.id_guru_mapel, 
  a.id_kelas, 
...
LEFT JOIN jadwal j 
  ON j.id_guru_mapel = gm.id_guru_mapel
  AND j.hari = DAYNAME(a.tanggal)
