...
switch ($page) {
    ...
    case 'absen_guru':
        require_once __DIR__ . '/../app/controllers/AbsensiController.php';
        (new AbsensiController())->absenGuru(); // ⬅️ method kamu yang baru
        break;




    case 'riwayat_harian_guru':
        require_once __DIR__ . '/../app/controllers/AbsensiController.php';
        $controller = new AbsensiController();
        $controller->riwayatHarianGuru();
        break;

    case 'riwayat_bulanan_guru':
        require_once __DIR__ . '/../app/controllers/AbsensiController.php';
        $controller = new AbsensiController(); // ✅ tambahkan baris ini
        $controller->riwayatBulananGuru();
        break;




    case 'ajax_riwayat_bulanan_guru':
        require_once __DIR__ . '/../app/controllers/AbsensiController.php';
        $controller = new AbsensiController();
        $controller->ajaxRiwayatBulananGuru();
        break;




    case 'absensi_harian_guru':
        require_once __DIR__ . '/../app/controllers/AdminController.php';
        $controller = new AdminController();
        $controller->absensiHarianGuru();
        break;


    case 'loadAbsensiLive': // ✅ tambahkan ini
