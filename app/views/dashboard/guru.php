...
<body>
    ...
    <div class="card">
        ...
        <p>Silakan lakukan absensi saat Anda berada di lingkungan sekolah dan sesuai jadwal mengajar.</p>

        <div style="text-align: center; margin-top: 1rem;">
            <button id="absen-btn" class="btn-absen">🕒 Absen Sekarang</button>
            <p id="absenStatus" style="margin-top: 0.5rem; font-weight: bold;"></p>
        </div>
    </div>
    ...
    <div class="card">
        <h3>📅 Riwayat Kehadiran Anda</h3>
        <p><a href="?page=riwayat_harian_guru">🕒 Riwayat Harian</a></p>
        <p><a href="?page=riwayat_bulanan_guru">📆 Riwayat Bulanan</a></p>
    </div>
    ...
    <script src="assets/js/dashboard_guru.js"></script>
